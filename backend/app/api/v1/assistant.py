...
async def assistant_chat(
    ...
    cited_srcs = agent_result.get("cited_sources", [])
    ...
    if current_user and active_conversation:
        assistant_db_msg = ChatMessage(
            ...
            triage_data={
                ...
                "cited_sources": cited_srcs,
                "requires_disclaimer": requires_disc,
            } if (agent_result.get("matching_hospitals") or requires_disc or cited_srcs) else None,
    ...
    async def event_generator():
        ...
        try:
            ...
            if current_user and active_conversation:
                ...
                stream_cited_srcs = final_meta.get("cited_sources", []) if final_meta else []
                ...
                assistant_db_msg = ChatMessage(
                    ...
                    triage_data={
                        ...
                        "cited_sources": stream_cited_srcs,
                        "requires_disclaimer": stream_requires_disc,
                    } if (matching_hosp or stream_requires_disc or stream_cited_srcs) else None,
            ...
            meta_payload = {
                ...
                "cited_sources": final_meta.get("cited_sources", []) if final_meta else [],
                "suggested_actions": final_meta.get("suggested_actions", []) if final_meta else [],
